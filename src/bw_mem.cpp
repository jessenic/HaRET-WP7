 ...
 *
 * This is a cosmetically modified version of lmbench; however due to
 * restrictions above the numbers resulted from it should NOT be published
 * as results of lmbench; rather refer to them as the results of HaRET
 * memory benchmark.
 */
